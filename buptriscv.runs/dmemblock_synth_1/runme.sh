...
HD_PWD='C:/Users/Regen/Desktop/buptriscv/buptriscv.runs/dmemblock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmemblock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmemblock.tcl
