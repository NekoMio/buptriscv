...
HD_PWD='C:/Users/Regen/Desktop/buptriscv/buptriscv.runs/imemblock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imemblock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imemblock.tcl
