...
HD_PWD='C:/Users/Regen/Desktop/buptriscv/buptriscv.runs/ddr3_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr3_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr3_mem.tcl
